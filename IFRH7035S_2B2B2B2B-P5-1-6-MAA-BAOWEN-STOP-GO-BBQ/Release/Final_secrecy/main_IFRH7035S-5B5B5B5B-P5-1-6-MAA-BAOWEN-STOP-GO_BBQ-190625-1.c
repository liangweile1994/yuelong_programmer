...
const u8 arr_T_Sens_H[16]={255,255,255,255,   10,  12,  13,13,  13,11,10,13,255,255,255,255};
...
{                 
  ...
  else
     {
     	if(bbq_L_bz ==0) 
        { 
         if((key_zone == Select_1_KEY)&&(boost_time_1))  {zone_1_level =9;boost_time_1 =0;boost_1_save =0;}
         if((key_zone == Select_2_KEY)&&(boost_time_2))  {zone_2_level =9;boost_time_2 =0;boost_2_save =0;}
	...
	if(bbq_R_bz ==0)
        {
         if((key_zone == Select_3_KEY)&&(boost_time_3))  {zone_3_level =9;boost_time_3 =0;boost_3_save =0;}
         if((key_zone == Select_4_KEY)&&(boost_time_4))  {zone_4_level =9;boost_time_4 =0;boost_4_save =0;}
...
{                   
     ...
     {      	   	    			
      ...
      { 
      	if(bbq_L_bz ==0) 
        { 
         if((key_zone == Select_1_KEY)&&(boost_time_1))  {zone_1_level =2;boost_time_1 =0;boost_1_save =0;}
         if((key_zone == Select_2_KEY)&&(boost_time_2))  {zone_2_level =2;boost_time_2 =0;boost_2_save =0;}
	...
	if(bbq_R_bz ==0)
        {
         if((key_zone == Select_3_KEY)&&(boost_time_3))  {zone_3_level =2;boost_time_3 =0;boost_3_save =0;}
         if((key_zone == Select_4_KEY)&&(boost_time_4))  {zone_4_level =2;boost_time_4 =0;boost_4_save =0;}
          	...
          	if((Power_on_bz == TRUE) &&(Pause_bz ==0) && (lock_bz == FALSE)) 
          	 {          	 	
        		...
        		if(key_ok_bit == KEY_FL)
          		{
          	       	if(key_account ==short_press_time)	{flex_L_key_deal();zone_flash_count =10;}  
        		...
        		if(key_ok_bit == KEY_FR)	
          		{
          	       	if(key_account ==short_press_time)	{flex_R_key_deal();zone_flash_count =10;}  
          	       	if(key_account ==lock_press_time)       bbq_key_deal();	//3S PRESS            	       	
          	       	speed_up();		
          		}
          		//------------------------------------------------ 
			...
			if(list_counter == 1) 							//1~18
				{						
					...
					if(Warm_status &Select_1_KEY)  temp_8 =Warm_function_deal(tmain_1,Warm_1_timer);
          						...
          						comm_deal(0,Add_1,temp_8,time_level_1,Err_1_data);  
          				} 
			...
			if(list_counter ==19)   						//19~36
				{						
					...
					if(Warm_status &Select_2_KEY)  temp_8 =Warm_function_deal(tmain_2,Warm_2_timer);
          						...
          						comm_deal(1,Add_2,temp_8,time_level_2,Err_2_data);  
          				}
			...
			if(list_counter ==37)							//37~54
				{	
					...
					if(Warm_status &Select_3_KEY)  temp_8 =Warm_function_deal(tmain_3,Warm_3_timer);
          						...
          						comm_deal(2,Add_3,temp_8,time_level_3,Err_3_data);    
          				} 
			...
			if(list_counter ==55)							//55~72
				{
					...
					if(Warm_status &Select_4_KEY)  temp_8 =Warm_function_deal(tmain_4,Warm_4_timer);
          						...
          						comm_deal(3,Add_4,temp_8,time_level_4,Err_4_data);       
          				} 
