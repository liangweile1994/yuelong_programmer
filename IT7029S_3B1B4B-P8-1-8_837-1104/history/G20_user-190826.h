...
//   Port define
//----------------------------------------------------------------
#define T_SCK_Port		GPIOF
#define T_SCK_Pin 	        GPIO_PIN_4	//PF4
...
#define RELAY_Pin 	        GPIO_PIN_6	//PD6 

#define FAN_Port		GPIOD
#define FAN_Pin 	        GPIO_PIN_7	//PD7 

#define BEEP_Port		GPIOB
#define BEEP_Pin 	        GPIO_PIN_0	//PB0 

#define TX_Port			GPIOD
#define TX_Pin 	        	GPIO_PIN_4	//PD4 

#define RX_Port			GPIOD
#define RX_Pin 	        	GPIO_PIN_5	//PD5 
...
#define K0_ENB_H 	((u8)0x00)			//0x23  non-disable K00~K07 touch
#define K1_ENB_H 	((u8)0x00)			//0x24  non-disable K10~K17 touch
#define K0_ENB_L 	((u8)0x33)			//0x23  disable K07 K00~K01 K04~K05 touch
#define K1_ENB_L 	((u8)0x9C)			//0x24  disable K17 K12~K14 touch
...
#define VALUE_VIF2		((u16)0x0001)	
#define VALUE_BOOST2		((u16)0x0002)
#define VALUE_TDEC2		((u16)0x0004)
#define VALUE_TINC2		((u16)0x0008)
#define VALUE_ON2		((u16)0x0010)	
#define VALUE_DEC2		((u16)0x0020)
#define VALUE_INC2		((u16)0x0040)
#define VALUE_DOUX2		((u16)0x0080)
#define VALUE_DOUX1		((u16)0x0100)
#define VALUE_INC1		((u16)0x0200)
#define VALUE_DEC1		((u16)0x0400)
#define VALUE_ON1		((u16)0x0800)	
#define VALUE_TINC1		((u16)0x1000)	
#define VALUE_TDEC1		((u16)0x2000)	
#define VALUE_BOOST1		((u16)0x4000)	
#define VALUE_VIF1		((u16)0x8000)	//APT address is high

#define VALUE_ON3		((u16)0x0004)	
#define VALUE_ON4		((u16)0x0008)
#define VALUE_F2		((u16)0x0040)
#define VALUE_TIMER2		((u16)0x0080)
#define VALUE_F1		((u16)0x0100)
#define VALUE_TIMER1		((u16)0x0200)	
#define VALUE_DEC3		((u16)0x2000)
#define VALUE_DEC4		((u16)0x4000)	//APT address is low

#define VALUE_BOOST4		((u16)0x0001)
#define VALUE_VIF4		((u16)0x0002)
#define VALUE_DOUX4		((u16)0x0004)
#define VALUE_INC4		((u16)0x0008)
#define VALUE_TDEC4		((u16)0x0010)
#define VALUE_ONOFF		((u16)0x0020)
#define VALUE_TIMER4		((u16)0x0040)
#define VALUE_TINC4		((u16)0x0080)
#define VALUE_TINC3		((u16)0x0100)
#define VALUE_TIMER3 		((u16)0x0200)
#define VALUE_LOCK		((u16)0x0400)
#define VALUE_TDEC3		((u16)0x0800)
#define VALUE_BOOST3		((u16)0x1000)
#define VALUE_VIF3		((u16)0x2000)
#define VALUE_DOUX3		((u16)0x4000)	
#define VALUE_INC3		((u16)0x8000)	//another APT address is high
...
// 1668 Display define
//----------------------------------------------------------------
#define SEG_B                   ((u8)0x01)
#define SEG_A                   ((u8)0x02)
#define SEG_C                   ((u8)0x04)
#define SEG_G                   ((u8)0x08)
#define SEG_F                   ((u8)0x10)
#define SEG_E                   ((u8)0x20)
#define SEG_P                   ((u8)0x40)
#define SEG_D                   ((u8)0x80) 
