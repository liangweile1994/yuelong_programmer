            ...
            if(Power_on_bz ==FALSE)  				  //off status
            	...
            	{             		
               	 	 ...
               	 	 if(temp_8)      		//if timer value is true	 	              	 	
               	   	...
               	   	//Disp_buf[3] =              	   	
               	  	Disp_buf[7] =ON_disp_zone_x((Warm_status &Select_1_KEY),0,bbq_L_bz,zone_1_level,&change_count,flex_L_bz,Select_1_KEY,flash_H_1_min,zone_1_nopan_time,zone_2_nopan_time,Err_1_data);	 //zone1 normal display
               	        
               	        //Disp_buf[15] =
              	 	Disp_buf[8] =ON_disp_zone_x((Warm_status &Select_2_KEY),1,bbq_L_bz,zone_2_level,&change_count,flex_L_bz,Select_2_KEY,flash_H_2_min,zone_2_nopan_time,zone_1_nopan_time,Err_2_data);	 //zone2 normal display               	
               	  	
               	  	//Disp_buf[13] =
               	  	Disp_buf[10] =ON_disp_zone_x((Warm_status &Select_3_KEY),2,bbq_R_bz,zone_3_level,&change_count,flex_R_bz,Select_3_KEY,flash_H_3_min,zone_3_nopan_time,zone_4_nopan_time,Err_3_data);	 //zone3 normal display
               	  	
               	  	//Disp_buf[1] =
               	  	Disp_buf[5] =ON_disp_zone_x((Warm_status &Select_4_KEY),3,bbq_R_bz,zone_4_level,&change_count,flex_R_bz,Select_4_KEY,flash_H_4_min,zone_4_nopan_time,zone_3_nopan_time,Err_4_data);	 //zone4 normal display
